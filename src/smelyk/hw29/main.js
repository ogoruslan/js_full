...
// Для цього вам знадобиться створити новий каталог для проекту, ініціалізувати npm (`npm init -y`), встановити Jest як 
// залежність розробки (`npm install --save-dev jest`) та додати в `package.json` скрипт для запуску тестів: `"test": "jest"`.
//     2. Тестування функції `ageClassification(num)`:** Ваше завдання полягає у написанні тестів для функції 
// `ageClassification(num)`, яка класифікує вік людини. 
