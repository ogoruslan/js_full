...
const sliderPrototype = {
  slides: document.querySelectorAll(".slide-items img"),
  currentSlideIndex: 0,
  indicators: document.querySelectorAll(".slider-indicators span"),
  sliderName: document.createTextNode(""),
  slideNames: new Map([
    [0, "Lia"],
    [1, "Tom"],
    [2, "Sam"],
  ...
  showSlide(index) {
    ...
    this.indicators.forEach(
      (indicator) => (indicator.style.width = INDICATOR_DEFAULT_WIDTH),
    );
...
const sliderA = Object.create(autoSlider);
